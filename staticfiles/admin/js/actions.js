...
(function($) {
    ...
    /*contador */
    var target_date = new Date("july 23, 2018").datTime();
//variable for time i¿units
var days, hours, minutes, seconds;

//get tag element
var countdown=document.getElementById("countdown-box");
var days-span=document.createElement("SPAN");
days_span.className='days';
countdown.appendChild(days_span);
var hours_span=document.createElement("SPAN");
hours_span.className='hours_span';
...
setInterval(function(){
    ...
    minutes_span.innerHTML=<'span class="number">'+days+'</span>'+'<span class="unit script">Mins</span>';
    secs_span.innerHTML=<'span class="number">'+days+'</span>'+'<span class="unit script">Segs</span>';
}, 1000);
